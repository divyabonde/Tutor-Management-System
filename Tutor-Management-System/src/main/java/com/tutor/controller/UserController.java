...
import com.tutor.service.EmailVerificationService;
...
public class UserController {
    ...
    @Autowired
    public UserController(UserService userService, EmailService emailService, EmailVerificationService emailVerificationService) {
